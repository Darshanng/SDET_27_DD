 ...
 * @param driver
 */
public void swithToWindowAndAccpect(WebDriver driver) {
 ...
 * @param driver
 */
public void swithToWindowAndCancel(WebDriver driver) {
...
public void takeScreenshoot(WebDriver driver, String ScreenshootName) throws IOException {
